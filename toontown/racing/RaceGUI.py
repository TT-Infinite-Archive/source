from panda3d.core import CardMaker, LineSegs, Point3, TextNode, VBase4, Vec3, Vec4
...
class RaceGUI:
    ...
    def __init__(self, distRace):
        ...
        self.gagCycleSound = loader.loadSfx('phase_3.5/audio/sfx/tick_counter.ogg')
        if hasattr(self.gagCycleSound, 'setPlayRate'):
            self.gagCycleSound.setPlayRate(0.2)
        self.gagCycleSound.setLoop(1)
        self.gagAcquireSound = loader.loadSfx('phase_6/audio/sfx/SZ_MM_gliss.ogg')
        self.disable()
        return
