...
class DistributedRacePadAI( DistributedKartPadAI, FSM ):
    ...
    def addAvBlock( self, avId, block ):
        """
        ...
        #    return EKartErrorCode.TRACK_CLOSED
        ...
        if( av.hasKart() and  (not self.trackType == RaceGlobals.Practice) ):
            ...
            if( avTickets < raceFee ):
                ...
                return EKartErrorCode.NOT_ENOUGH_TICKETS

        # Call the Super Class Method
        success = DistributedKartPadAI.addAvBlock( self, avId, block )
