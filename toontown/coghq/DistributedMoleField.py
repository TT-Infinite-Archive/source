from panda3d.core import GeomNode, NodePath, Plane, Point3
...
class DistributedMoleField(DistributedNodePathEntity, MoleFieldBase.MoleFieldBase):
    ...
    def loadModel(self):
        ...
        self.centerCenterNode()
        self.soundBomb = loader.loadSfx('phase_12/audio/sfx/Mole_Surprise.ogg')
        self.soundBomb2 = loader.loadSfx('phase_3.5/audio/dial/AV_pig_howl.ogg')
        self.soundCog = loader.loadSfx('phase_12/audio/sfx/Mole_Stomp.ogg')
        self.soundUp = loader.loadSfx('phase_4/audio/sfx/MG_Tag_C.ogg')
        self.soundDown = loader.loadSfx('phase_4/audio/sfx/MG_cannon_whizz.ogg')
