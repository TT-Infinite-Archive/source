from panda3d.core import CollideMask, CollisionNode, CollisionTube, NodePath, Point3, TextureStage
...
class DistributedFoodBelt(DistributedObject.DistributedObject, FSM.FSM, FoodBeltBase):
    ...
    def loadAssets(self):
        ...
        self.beltSound = loader.loadSfx('phase_12/audio/sfx/CHQ_FACT_conveyor_belt.ogg')
