...
class DistributedBattleFactoryAI(DistributedLevelBattleAI.DistributedLevelBattleAI):
    ...
    def handleToonsWon(self, toons):
        for toon in toons:
            ...
            newMerits = self.level.currentMeritCount - self.toonMerits[toon.doId][3]
            meritArray = self.air.promotionMgr.recoverMerits(toon, self.suitsKilled, self.getTaskZoneId(), hardValue=newMerits)
