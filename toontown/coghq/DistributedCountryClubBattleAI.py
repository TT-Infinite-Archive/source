...
class DistributedCountryClubBattleAI(DistributedLevelBattleAI.DistributedLevelBattleAI):
    ...
    def handleToonsWon(self, toons):
        ...
        for toon in toons:
            ...
            meritArray = self.air.promotionMgr.recoverMerits(toon, self.suitsKilled, self.getTaskZoneId(), extraMerits=extraMerits,
                                                             multiplier=getCountryClubCreditMultiplier(self.getTaskZoneId()))
