...
class Trolley(StateData.StateData):
    ...
    def enterTrolleyCS(self):
        self.noTrolleyBox = TTDialog.TTGlobalDialog(message=TTLocalizer.TrolleyCSMessage, doneEvent='noTrolleyAck', style=TTDialog.Acknowledge)
