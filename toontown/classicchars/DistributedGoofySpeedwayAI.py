...
class DistributedGoofySpeedwayAI(DistributedCCharBaseAI.DistributedCCharBaseAI):
    ...
    def handleHolidays(self):
        ...
        if hasattr(simbase.air, 'holidayManager'):
            if ToontownGlobals.APRIL_FOOLS_DAY in simbase.air.holidayManager.currentHolidays:
                if simbase.air.holidayManager.currentHolidays[ToontownGlobals.APRIL_FOOLS_DAY] != None and simbase.air.holidayManager.currentHolidays[ToontownGlobals.APRIL_FOOLS_DAY].getRunningState():
