...
class DistributedMickeyAI(DistributedCCharBaseAI.DistributedCCharBaseAI):
    ...
    def handleHolidays(self):
        ...
        if hasattr(simbase.air, "holidayManager"):
            if ToontownGlobals.APRIL_FOOLS_COSTUMES in simbase.air.holidayManager.currentHolidays and \
                    simbase.air.holidayManager.currentHolidays[ToontownGlobals.APRIL_FOOLS_COSTUMES] != None \
