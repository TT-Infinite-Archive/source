from panda3d.core import CollideMask, CollisionNode, CollisionSphere, CollisionTube, NodePath, Point3, Vec3, rad2Deg
import math
...
class CogThiefRewritten(DirectObject):
    notify = directNotify.newCategory('CogThiefRewritten')
