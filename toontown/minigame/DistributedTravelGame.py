from panda3d.core import Plane, PlaneNode, Point2, Point3, TextNode, VBase4, Vec3, Vec4, rad2Deg
...
class DistributedTravelGame(DistributedMinigame):
    ...
    def __init__(self, cr):
        ...
        self.turntableRotateSfx = loader.loadSfx('phase_4/audio/sfx/MG_sfx_travel_game_turntble_rotate_2.ogg')
        self.wonGameSfx = loader.loadSfx('phase_4/audio/sfx/MG_sfx_travel_game_bonus.ogg')
        self.lostGameSfx = loader.loadSfx('phase_4/audio/sfx/MG_sfx_travel_game_no_bonus_2.ogg')
        self.noWinnerSfx = loader.loadSfx('phase_4/audio/sfx/MG_sfx_travel_game_no_bonus.ogg')
        self.boardIndex = 0
        self.avNames = []
