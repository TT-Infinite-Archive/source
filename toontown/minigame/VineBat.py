...
class VineBat(NodePath, DirectObject):
    ...
    def __init__(self, batIndex, timeToTraverseField):
        ...
        self.screechSfx = loader.loadSfx('phase_4/audio/sfx/MG_sfx_vine_game_bat_shriek_3.ogg')
        self.flySfx = loader.loadSfx('phase_4/audio/sfx/MG_sfx_vine_game_bat_flying_lp.ogg')
