...
class VoteResultsTrolleyPanel(DirectFrame):
    ...
    def __init__(self, numPlayers, avIdList, votes, directions, namesList, disconnectedList, directionToGo, directionReason, directionTotals, *args, **kwargs):
        ...
        self.downArrowSfx = []
        for i in xrange(5):
            self.upArrowSfx.append(loader.loadSfx('phase_4/audio/sfx/MG_sfx_travel_game_blue_arrow.ogg'))
            self.downArrowSfx.append(loader.loadSfx('phase_4/audio/sfx/MG_sfx_travel_game_red_arrow.ogg'))

        self.winVoteSfx = loader.loadSfx('phase_4/audio/sfx/MG_sfx_travel_game_win_vote.ogg')
        self.noVoteSfx = loader.loadSfx('phase_4/audio/sfx/MG_sfx_travel_game_square_no_vote_1.ogg')
        self.loseVoteSfx = loader.loadSfx('phase_4/audio/sfx/MG_sfx_travel_game_lose_vote.ogg')
