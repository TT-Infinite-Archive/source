...
class PairingGameCard(PlayingCardNodePath):
    ...
    def load(self):
        ...
        self.setScale(2.5)
        self.flipIval = None
        self.turnUpSound = loader.loadSfx('phase_4/audio/sfx/MG_pairing_card_flip_face_up.ogg')
        self.turnDownSound = loader.loadSfx('phase_4/audio/sfx/MG_pairing_card_flip_face_down.ogg')
        return
