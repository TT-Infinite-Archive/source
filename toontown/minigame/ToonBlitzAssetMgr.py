...
class ToonBlitzAssetMgr(DirectObject):
    ...
    def load(self):
        ...
        self.watergunSound = loader.loadSfx('phase_4/audio/sfx/AA_squirt_seltzer_miss.ogg')
        self.splashSound = loader.loadSfx('phase_4/audio/sfx/Seltzer_squirt_2dgame_hit.ogg')
