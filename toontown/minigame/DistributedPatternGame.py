...
class DistributedPatternGame(DistributedMinigame):
    ...
    def load(self):
        ...
        for soundName in self.ButtonSoundNames:
            self.buttonSounds.append(loader.loadSfx(soundName))

        self.correctSound = loader.loadSfx('phase_4/audio/sfx/MG_pos_buzzer.ogg')
        self.incorrectSound = loader.loadSfx('phase_4/audio/sfx/MG_neg_buzzer.ogg')
        self.perfectSound = loader.loadSfx('phase_4/audio/sfx/MG_win.ogg')
        self.fallSound = loader.loadSfx('phase_4/audio/sfx/MG_Tag_A.ogg')
