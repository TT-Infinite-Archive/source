class ChineseCheckersBoard:
    ...
    def getSquare(self, i):
        return self.squareList[i]

    def getSquareOffset(self, i):
        return self.squareList[i - 1]

    def getState(self, i):
        return self.squareList[i].getState()

    def getStateOffset(self, i):
        return self.squareList[i - 1].getState()

    def setState(self, i, state):
        self.squareList[i].setState(state)

    def setStateOffset(self, i, state):
        self.squareList[i - 1].setState(state)

    def getAdjacent(self, i):
        return self.squareList[i].getAdjacent()

    def getAdjacentOffset(self, i):
        return self.squareList[i - 1].getAdjacent()

    def getStates(self):
        return [square.getState() for square in self.squareList]

    def setStates(self, states):
        for i, square in enumerate(self.squareList):
            square.setState(states[i])
