...
# TODO TTI: reimplement st patrick's day treasure
class TreasurePlannerAI(DirectObject.DirectObject):
    notify = DirectNotifyGlobal.directNotify.newCategory(
        "TreasurePlannerAI")

    def __init__(self, zoneId, treasureType, spawnPoints, callback=None):

        self.zoneId = zoneId
        self.treasureType = treasureType
        self.spawnPoints = spawnPoints

        self.treasureConstructor = DistributedTreasureAI
    ...
    def validAvatar(self, av) -> bool:
        # This is called to ask if this
