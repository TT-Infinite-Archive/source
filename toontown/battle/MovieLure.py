from panda3d.core import ConfigVariableBool, Plane, PlaneNode, Point3, Point4, Vec3, Vec4
...
def __createFishingPoleMultiTrack(lure, dollar, dollarName):
    ...
    if suit.buffIndex == SuitBuffStable:
        tracks.append(Sequence(Wait(3.7), Func(MovieUtil.indicateText, suit, TTLocalizer.Immune, 1.1)))
    elif sidestep == 0:
