...
class Nametag:
    ...
    GUILD_TEXT_WORD_WRAP = 0
    GUILD_TEXT_GLYPH_SCALE = 0.75
    ...
    def __init__(self):
        ...
        self.guildTextNode = TextNode('guildText')
        self.guildTextNode.setWordwrap(self.GUILD_TEXT_WORD_WRAP)
        self.guildTextNode.setAlign(TextNode.ACenter)
        self.guildTextNode.setGlyphScale(self.GUILD_TEXT_GLYPH_SCALE)
        self.guildTextNode.setTextColor(NametagGlobals.guildColor)
    ...
    def setGuildFont(self, guildFont):
        ...
        if self.guildFont is not None:
            self.guildTextNode.setFont(self.guildFont)
        self.update()

    def getGuildFont(self, guildFont):
    ...
    def setGuildText(self, guildText):
        self.guildTextNode.setText(guildText)

    def getGuildText(self):
        return self.guildTextNode.getText()
