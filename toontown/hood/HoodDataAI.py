...
class HoodDataAI:
    ...
    def createTreasurePlanner(self):
        treasureAttribs = SZTreasureSpawnPoints.get(self.zoneId)
        if treasureAttribs:
            self.treasurePlanner = SZTreasurePlannerAI(self.zoneId,
                                                       treasureAttribs.treasureType,
                                                       treasureAttribs.healAmount,

                                                       treasureAttribs.spawnPoints,
                                                       f"SZTreasurePlannerAI-{self.zoneId}",
                                                       treasureAttribs.spawnInterval,
                                                       treasureAttribs.maxTreasures)
            self.treasurePlanner.start()

    def createFishingPonds(self):
        # Note: A list of fishing ponds is now maintained for easier access
