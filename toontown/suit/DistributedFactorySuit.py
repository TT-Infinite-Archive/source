from panda3d.core import CollideMask, CollisionNode, CollisionSphere, ColorBlendAttrib, NodePath, Point3, VBase3, Vec3
...
class DistributedFactorySuit(DistributedSuitBase.DistributedSuitBase, DelayDeletable):
    ...
    def getTreasureId(self):
        return self.treasureId

    def dropTreasure(self):
        treasure = base.cr.doId2do.get(self.treasureId)
        if treasure is not None:
            treasure.playDropTrack()
