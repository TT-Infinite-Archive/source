...
class PetAvatarPanel(AvatarPanel.AvatarPanel):
    ...
    def __init__(self, avatar):
        ...
        self.feedButton = DirectButton(
            ...
            relief=None, text=TTLocalizer.PetPanelFeed,
        ...
        messenger.send(EventGlobals.PetPanelDone)
    ...
    def __handleToOwner(self):
        ...
        if handle != None:
            self.cleanup()
            messenger.send(EventGlobals.ClickedNameTag, [handle])
        else:
            self.disableAll()
    ...
    def __ownerDetailsLoaded(self, avatar):
        ...
        if avatar is not None:
            messenger.send(EventGlobals.ClickedNameTag, [avatar])
