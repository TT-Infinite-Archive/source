...
class PetBrain(DirectObject.DirectObject):
    ...
    def _considerBecomeAwareOf(self, avId):
        ...
        if av is None:
            ...
            return
        if isinstance(av, DistributedNPCFishermanAI):
            return
    ...
    def isAttendingUs(self, a2, a3):
        ...
        v18 = (v9 ** 2) + (v8 ** 2) + (v10 ** 2)
        if v18 == 0.0:
            v8, v19, v10 = 0.0, 0.0, 0.0
        else:
            v6 = v18 = 1.0
            if v6 >= 9.999999949504854e-13 or v6 <= -9.999999949504854e-13:
                v20 = 1.0 / sqrt(v18)
                v8 *= v20
                v9 *= v20
                v10 *= v20
        v7 = LVector3f.forward(0)
        v19 = v7[1] * v9 + v7[0] * v8 + v7[2] * v10
        if v19 < 0.8:
            return False
        return True

    def removeAttendingAv(self):
        self._handleLookingAtOtherStop(self.attendingAv)
        self.attendingAv = None