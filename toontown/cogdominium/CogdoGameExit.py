...
class CogdoGameExit(NodePath):
    ...
    def __init__(self, openSfx = None, closeSfx = None):
        ...
        self._openSfx = openSfx or loader.loadSfx('phase_9/audio/sfx/CHQ_VP_door_open.ogg')
        self._closeSfx = closeSfx or loader.loadSfx('phase_9/audio/sfx/CHQ_VP_door_close.ogg')
