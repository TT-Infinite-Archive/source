...
class DistCogdoGame(DistCogdoGameBase, DistributedObject):
    ...
    def __init__(self, cr):
        ...
        base.cogdoGame = self
        base.cr.cogdoGame = self
        self._waitingStartLabel = DirectLabel(text=CogdoGameConsts.WaitingForOtherPlayers, text_fg=VBase4(1, 1, 1, 1), relief=None, pos=(-0.6, 0, -0.75), scale=0.075)
    ...
    def enterWaitServerStart(self):
        ...
        if numToons > 1:
            msg = CogdoGameConsts.WaitingForOtherPlayers
        else:
            msg = CogdoGameConsts.PleaseWait
