...
Tutorial = ('to the', 'in the', 'Prologue')
...
FADoorCodes_DEFEAT_FLUNKY_TOM = 'Jump on the floating objects to get around. Head toward the floating Toontown Central Plaza and defeat that Flunky!'
...
ToonSleepString = '. . . ZZZ . . .'
MovieTutorialReward1 = 'You received gag experience!'
MovieTutorialReward2 = 'Each time you level up your gag, it will become stronger! Every gag has 10 levels.'
...
PromptTutorial = "Would you like to enter the Toontown Infinite Prologue or teleport directly to Toontown Central?\n\nThe Prologue is the beginning of the Toontown Infinite storyline. For those who like following the lore and the game's story, it would be the ideal choice to play through it.\n\nNote: We recommend that you play through it even if you are an experienced Toon because a lot of the original game mechanics that you may remember have been changed."
MakeAToonSkipTutorial = 'Skip the Prologue'
MakeAToonEnterTutorial = 'Enter the Prologue'
MakeAToonDone = 'Done'
