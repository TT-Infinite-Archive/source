...
STOREOWNER_GREETING = 'Choose what you want to use.'
...
TrackThrow = 'Throw'
TrackDrop = 'Drop'
GagSelectNoGags = 'No Gags in this category!'
GagSelectClickToEquip = 'Click to Equip'
GagSelectClickToUnEquip = 'Click to Un-Equip'
GagSelectEquipped = 'Equipped'
GagSelectNoGagInfo = 'Hover over a gag to view information about it!'