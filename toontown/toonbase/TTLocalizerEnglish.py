...
AvatarChooserQuit = 'Quit Game'
AvatarChooserPlay = 'Play'
AvatarChooserCreate = 'Create'
AvatarChooserNameYourToon = 'Name Toon'
AvatarChooserMove = 'Move'
AvatarChooserMoveHere = 'Move Here'
AvatarChooserSwap = 'Swap'
AvatarChooserMoveTitle = 'Pick  A  New  House'
