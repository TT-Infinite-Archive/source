...
def getCreditMultiplier(floorIndex):
    return 1 + floorIndex * 0.45


def getGagCreditMultiplier(floorIndex, lvlPool):
    return 1.5 + (floorIndex * 0.5) + round(lvlPool * 0.0135, 2)
...
def getMintCreditMultiplier(mintId):
    return {CashbotMintIntA: 2.0,
     CashbotMintIntB: 2.25,
     CashbotMintIntC: 2.5}.get(mintId, 1.0)
...
def getCountryClubCreditMultiplier(countryClubId):
    return {BossbotCountryClubIntA: 2.0,
     BossbotCountryClubIntB: 2.25,
     BossbotCountryClubIntC: 2.5}.get(countryClubId, 1.0)
