...
@magicWord(category=CATEGORY_USER2, types=[int, int])
...
@magicWord(category=CATEGORY_USER2, types=[int, str])
def sos(count, name):
    """
...
@magicWord(category=CATEGORY_USER2, types=[str, int])
...
@magicWord(category=CATEGORY_USER2, types=[str, str, int])
