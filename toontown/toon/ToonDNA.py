...
class ToonDNA(AvatarDNA.AvatarDNA):
    ...
    def makeArgString(self):
        string = "('%s', '%s', '%s', '%s', %d, %d, %d, %d, %d, %d, %d, %d, %d, %d)" % (self.head, self.torso, self.legs,
                                                                                       self.gender, self.armColor,
                                                                                       self.gloveColor, self.legColor,
                                                                                       self.headColor, self.topTex,
                                                                                       self.topTexColor, self.sleeveTex,
                                                                                       self.sleeveTexColor, self.botTex,
                                                                                       self.botTexColor)
        return string
    ...
    def makeFromNetString(self, string):
        ...
        if oldDna:
            self.colorDNA.headColor.resetRgb(*allColorsList[self.headColor])
            self.colorDNA.armColor.resetRgb(*allColorsList[self.armColor])
            self.colorDNA.legColor.resetRgb(*allColorsList[self.legColor])
        else:
