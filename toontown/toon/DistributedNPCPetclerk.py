...
class DistributedNPCPetclerk(DistributedNPCToonBase):
    ...
    def setPetData(self, petSeeds, petDNA, petTraitSeeds):
    ...
    def popupPetshopGUI(self, task):
        ...
        self.petshopGui = PetshopGUI.PetshopGUI(self.eventDict, self.petSeeds, self.petDNA, self.petTraitSeeds)
