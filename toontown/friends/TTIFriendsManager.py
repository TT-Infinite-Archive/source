...
class TTIFriendsManager(DistributedObjectGlobal):
    ...
    def friendOnline(self, id, commonChatFlags, whitelistChatFlags, chatMode):
        base.cr.handleFriendOnline(id, commonChatFlags, whitelistChatFlags, chatMode)
    ...
    def friendDetails(self, avId, inventory, trackAccess, trophies, hp, maxHp, defaultShard, lastHood, dnaString,
                      experience, trackBonusLevel, guildName):
        fields = [
    ...
    def d_getAvatarDetailsExtended(self, avId):
        self.sendUpdate('getAvatarDetailsExtended', [avId])
    ...
    def d_addIgnore(self, ignoredAvId):
        self.sendUpdate('addIgnore', [ignoredAvId])

    def b_addIgnore(self, ignoredAvId):
        self.addIgnore(ignoredAvId)
    ...
    def d_removeIgnore(self, ignoredAvId):
        self.sendUpdate('removeIgnore', [ignoredAvId])

    def b_removeIgnore(self, ignoredAvId):
        self.removeIgnore(ignoredAvId)
