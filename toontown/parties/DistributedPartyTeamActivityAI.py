...
#===============================================================================
    ...
    def _addToonToTeam(self, toonId, team):
        ...
        Parameters
            toonId toon's doId
            team team number based on PartyGlobals.ETeamActivityTeam
...
#===============================================================================
    ...
    def toonJoinRequest(self, team):
        ...
        Parameters:
          team: The team the toon is trying to join as a
                PartyGlobals.ETeamActivityTeam value
        """        
        ...
        if self.isTeamFull(team):
            # decline the toon
            self.sendToonJoinResponse(toonId, False, team, PartyGlobals.EDenialReason.FULL)
    ...
    def sendToonJoinResponse(self, toonId, joined, team, denialReason=PartyGlobals.EDenialReason.DEFAULT):
        """
        ...
        Parameters:
            ...
            team- which team the toon joined, as a PartyGlobals.ETeamActivityTeam
                  value
    ...
    def toonExitRequest(self, team):
        ...
        Parameters:
            team- which team the toon is on, as a PartyGlobals.ETeamActivityTeam
                  value
        """
    ...
    def sendToonExitResponse(self, toonId, exited, team, denialReason=PartyGlobals.EDenialReason.DEFAULT):
        """
    ...
    def toonSwitchTeamRequest(self):
        ...
        if state != "WaitForEnough" and state != "WaitToStart":
            self.d_sendSwitchTeamRequestDeniedToAvatarId(senderId, PartyGlobals.EDenialReason.DEFAULT)
            return
        ...
        if not self.isTeamFull(otherTeam):
            ...
            self.d_sendSwitchTeamRequestDeniedToAvatarId(senderId, PartyGlobals.EDenialReason.FULL)
        ...
        for toonId, reward in self.toonIdsToJellybeanRewards.items():
            if reward > 0:
                self.sendUpdateToAvatarId(
                    ...
                    "showJellybeanReward", [
                    reward,
                    self.air.doId2do[toonId].getBankMoney(),
...
#===============================================================================
    ...
    def getTeamName(self, team):
        """
        Parameters
            team is the team index (see PartyGlobals.ETeamActivityTeam)
            
        Returns
            The team name
        """
        return PartyGlobals.ETeamActivityTeam(team).name
    ...
    def getTeam(self, toonId):
        ...
        PartyGlobals.ETeamActivityTeam value, or None if toonId isn't on either team.
