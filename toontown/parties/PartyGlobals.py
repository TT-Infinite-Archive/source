...
WinterPartyActivityIds = frozenset(
    [ActivityIds.PartyWinterCatch, ActivityIds.PartyWinterTrampoline, ActivityIds.PartyWinterCog])
...
PartyGridToPandaOffset = (
    -PartyGridUnitLength[0] * PartyEditorGridSize[0] / 2.0, -PartyGridUnitLength[1] * PartyEditorGridSize[1] / 2.0)
...
Name2DropObjectType = {}
for typeX in DropObjectTypes:
    Name2DropObjectType[typeX.name] = typeX
