...
class DistributedPartyFireworksActivityAI(DistributedPartyActivityAI):
    ...
    def __init__(self, air, partyDoId, x, y, h, eventId=PartyGlobals.EFireworkShow.SUMMER, showStyle=0):
        """
        air: instance of ToontownAIRepository
        eventId: a PartyGlobals.EFireworkShow value that tells us which show
                 to run
        """
