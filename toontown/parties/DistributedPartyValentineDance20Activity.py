...
class DistributedPartyValentineDance20Activity(DistributedPartyDanceActivityBase):
    ...
    def __init__(self, cr):
        DistributedPartyDanceActivityBase.__init__(self, cr, PartyGlobals.EActivityId.PartyDance20, PartyGlobals.DancePatternToAnims20, model='phase_13/models/parties/tt_m_ara_pty_danceFloorValentine')
