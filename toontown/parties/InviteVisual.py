...
class InviteVisual(DirectFrame):
    ...
    def __init__(self, parent):
        ...
        self.inviteThemesIdToInfo = {PartyGlobals.EInviteTheme.BIRTHDAY: (self.gui.find('**/birthdayPage'), TTLocalizer.PartyPlannerBirthdayTheme, (0.0,
                                              0.0,
                                              0.0,
                                              1.0)),
         PartyGlobals.EInviteTheme.GENERIC_MALE: (self.gui.find('**/genericMalePage'), TTLocalizer.PartyPlannerGenericMaleTheme, (0.7,
                                                 0.7,
                                                 0.0,
                                                 1.0)),
         PartyGlobals.EInviteTheme.GENERIC_FEMALE: (self.gui.find('**/genericFemalePage'), TTLocalizer.PartyPlannerGenericFemaleTheme, (0.0,
                                                   1.0,
                                                   0.5,
                                                   1.0)),
         PartyGlobals.EInviteTheme.RACING: (self.gui.find('**/racingPage'), TTLocalizer.PartyPlannerRacingTheme, (0.0,
                                            0.0,
                                            0.0,
                                            1.0)),
         PartyGlobals.EInviteTheme.VALENTOONS: (self.gui.find('**/valentinePage1'), TTLocalizer.PartyPlannerValentoonsTheme, (0.0,
                                                0.0,
                                                0.0,
                                                1.0)),
         PartyGlobals.EInviteTheme.VICTORY_PARTY: (self.gui.find('**/victoryPartyPage'), TTLocalizer.PartyPlannerVictoryPartyTheme, (0.0,
                                                  0.0,
                                                  0.0,
                                                  1.0)),
         PartyGlobals.EInviteTheme.WINTER: (self.gui.find('**/winterPartyPage1'), TTLocalizer.PartyPlannerWinterPartyTheme, (1.0,
                                            1.0,
                                            1.0,
                                            1.0))}
