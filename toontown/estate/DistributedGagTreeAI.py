...
class DistributedGagTreeAI(DistributedPlantBaseAI):
    ...
    def canHarvest(self):
        return self.getGrowthState() == GardenGlobals.FULL_TREE and not self.wilted
    ...
    def construct(self, gardenData):
        ...
        # Still have to unpack this even though its useless now.
        self.wilted = gardenData.getUint8()

        self.wilted = self.waterLevel < 0
