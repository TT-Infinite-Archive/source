...
class EstateLoader(SafeZoneLoader.SafeZoneLoader):
    ...
    def __init__(self, hood, parentFSM, doneEvent):
        ...
        self.musicFile = 'phase_5/audio/bgm/estate_bgm.ogg'
    ...
    def load(self):
        ...
        self.cricketSound = list(map(loader.loadSfx, ['phase_4/audio/sfx/SZ_TC_bird1.ogg', 'phase_4/audio/sfx/SZ_TC_bird2.ogg', 'phase_4/audio/sfx/SZ_TC_bird3.ogg']))
