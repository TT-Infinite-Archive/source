...
BOX_THREE = 3
standardFlowerBoxes = (
 (8.679, -6.138, -90, BOX_ONE),
 (8.679, 5.041, -90, BOX_ONE),
 (0.265, -8.375, -180, BOX_THREE),
 (0.265, 7.278, 0, BOX_THREE),
 (-9.656, -0.325, 90, BOX_TWO))

tikiFlowerBoxes = (
 (8.456, -5.468, -90, BOX_ONE),
 (8.322, 4.326, -90, BOX_ONE),
 (1.524, -7.704, -180, BOX_THREE),
 (0.764, 7.546, 0, BOX_THREE),
 (-7.51, -0.057, 90, BOX_TWO))

teepeeFlowerBoxes = (
 (12.423,  -0.308, -90, BOX_ONE),
 (12.423,  9.934, -90, BOX_ONE),
 (-0.432,  -10.732, -180, BOX_THREE),
 (0.287,  12.505, 0, BOX_THREE),
 (-12.430,  0.258, 90, BOX_TWO))
...
castleFlowerBoxes = (
 ...
 (0.265, -8.375, -180, BOX_THREE),
 (0.265, 7.278, 0, BOX_THREE),
 (-7.5, -0.325, 90, BOX_TWO))

rusticFlowerBoxes = (
 (10.308,  -10.858, -90, BOX_ONE),
 (10.308, 10.558, -90, BOX_ONE),
 (-4.243,  -11.609, -180, BOX_THREE),
 (-4.243,  10.558, 0, BOX_THREE),
 (-13.527, -0.325, 90, BOX_TWO))
estateBoxes = (standardFlowerBoxes,
               tikiFlowerBoxes,
               teepeeFlowerBoxes,
               castleFlowerBoxes,
               standardFlowerBoxes,
