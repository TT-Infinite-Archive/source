...
class CatalogClothingItem(CatalogItem.CatalogItem):
    ...
    def makeNewItem(self, clothingType, colorIndex=0, loyaltyDays = 0):
    ...
    def recordPurchase(self, avatar, optional):
        ...
        if self.isShirt():
            ...
            if added:
                ...
                self.notify.warning('Avatar %s lost current shirt; closet full.' % avatar.doId)
            defn = ToonDNA.ShirtStyles[str]
            dna.topTex = defn[0]
            ...
            if added:
                ...
                self.notify.warning('Avatar %s lost current bottoms; closet full.' % avatar.doId)
            defn = ToonDNA.BottomStyles[str]
            dna.botTex = defn[0]
