...
class AIZoneDataObj:
    ...
    def startCollTrav(self, respectPrevTransform = 1, cTravName = None):
        ...
        if cTravName not in self._collTravsStarted:
            ...
            taskMgr.add(self._doCollisions, self._getCTravTaskName(name=cTravName), priority=OTPGlobals.AICollisionPriority,
                        extraArgs=[self._zoneId, None, cTravName])
