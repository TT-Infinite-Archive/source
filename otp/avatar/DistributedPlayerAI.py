...
class DistributedPlayerAI(DistributedAvatarAI.DistributedAvatarAI, PlayerBase.PlayerBase, ClsendTracker):
    ...
    def d_setChatMode(self, chatMode):
        self.sendUpdate('setChatMode', [chatMode])

    def b_setChatMode(self, chatMode):
        self.setChatMode(chatMode)
        self.d_setChatMode(chatMode)
