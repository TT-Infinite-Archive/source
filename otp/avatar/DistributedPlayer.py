...
class DistributedPlayer(DistributedAvatar.DistributedAvatar, PlayerBase.PlayerBase, TelemetryLimited):
    ...
    def teleportQuery(self, requesterId):
        ...
        if avatar != None:
            ...
            if base.cr.ttiFriendsManager.checkIgnored(requesterId):
    ...
    def d_teleportResponse(self, avId, available, shardId, hoodId, zoneId, sendToId):
        ...
        base.cr.ttiFriendsManager.d_teleportResponse(sendToId, available, shardId, hoodId, zoneId)
    ...
    def setChatMode(self, chatMode):
        ...
        if self.isLocal():
            self.cr.whiteListChatEnabled = chatMode
